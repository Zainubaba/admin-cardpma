                    ...
                    <div class="card">
                        <div class="card-header" style="display: flex; justify-content: space-between;">
                            <h3 class="card-title" style="font-weight: bold;">
                                <a>District-Wise Students Forwarded To BOP</a>
                            </h3>
            ...
            $(() => {
                $('#gridContainer').dxDataGrid({
...

                  {
                    ...
                    cssClass: 'bullet',
                    cellTemplate: function(container, options) {
                        const value = options.value; // count is a number, not an object
                        const d_id = options.data.d_id; // assuming d_id is available in your row data
                        const url = `/totalforward/${d_id}`;
                        $('<a>')
                            .attr('href', url)
                            .text(value)
                            .appendTo(container);
