    ...
    <div id="content-wrapper" class="d-flex flex-column" style="">
        <div class="content-container">
            ...
            <div class="row card-body">
                ...
                <div class="col-md-3">
                    @if ($d->photo)
                        <img src="{{ asset('uploads/' . $d->photo) }}" alt="Profile Image" style="max-width:100px;" />
                    @else
                        <span>N/A</span>
                    @endif
                </div>
            ...
            <div class="row card-body">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control form-control-inline" value="{{ $d->nearby_station ?? 'N/A' }}">
                </div>
            </div>
            ...
            <div class="row card-body">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control form-control-inline" value="{{ $d->system_name ?? 'N/A' }}">
                </div>
            </div>
            ...
            <div class="row card-body">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control form-control-inline" value="{{ $d->stop ?? 'N/A' }}">
                </div>
            </div>

            <div class="row card-body">
                <div class="col-md-3">
                    <label>BOP Branch:</label>
                </div>
                <div class="col-md-9">
                    <input type="text" class="form-control form-control-inline" value="{{ $d->bop_branch ?? 'N/A' }}">
                </div>
            ...
            <div class="row card-body">
                @if ($d->cnic_front)
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('uploads/' . $d->cnic_front) }}" alt="CNIC Front" style="max-width:100px;" />
                    </div>
                @endif
                @if ($d->cnic_back)
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('uploads/' . $d->cnic_back) }}" alt="CNIC Back" style="max-width:100px;" />
                    </div>
                @endif
            </div>
            <div class="row card-body">
                @if ($d->bform)
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('uploads/' . $d->bform) }}" alt="B-Form" style="max-width:100px;" />
                    </div>
                @endif
                @if ($d->student_id_card)
                    ...
                    <div class="col-md-3">
                        <img src="{{ asset('uploads/' . $d->student_id_card) }}" alt="Student ID Card" style="max-width:100px;" />
                    </div>
                @endif
            </div>

@if($d->verified_users != NULL)
            ...
            <div class="row card-body">
                ...
                @if($d->feedback != NULL)
                    ...
                    <div class="col-md-3">
                            ...
                            <input type="text" class="form-control form-control-inline" value="{{$d->feedback}}">
                    </div>
                @endif
