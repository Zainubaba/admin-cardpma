        ...
        <div class="col-md-12" style="margin-top: -100px;">
            ...
            <div class="row" style="margin-top: 60px;">
                ...
                <div class="col-md-4 col-sm-12 ">
                    <div class="row imgback mt-4" style="">
                        <div class="col-md-12 col-sm-12">

                            <div class="row ist">

                                <div class="col-md-12 col-sm-12" style="height: 350px;">
                                    <img src="{{ asset('images/auth/icon01.png') }}" width="280px" alt="" style=" margin-left:20px; margin-top:25px;">
                                </div>
                                {{-- <div class="col-md-6 col-sm-6" style="height: 200px;">
                                    <img src="{{ asset('images/auth/icon02.png') }}" width="220px" alt="">
                                </div> --}}
                            </div>
                        </div>
                        {{-- <div class="col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6" style="height: 200px;">
                                    <img src="{{ asset('images/auth/icon03.png') }}" width="200px;" style="margin-left:15px;" alt="">
                                </div>
                                <div class="col-md-6 col-sm-6" style="height: 200px;">
                                    <img src="{{ asset('images/auth/icon04.png') }}" width="220px; "
                                    alt="">
                                </div>
                            </div>
                        </div> --}}
