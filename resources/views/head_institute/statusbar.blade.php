...
@section('content')
  ...
  .progress-meter .progress-point[data-query-type="ii"]:after {
        ...
        counter-increment: stepii {{ $submittedform }};
    }
...
.progress-meter .progress-point[data-query-type="dd"]:after {
    counter-reset: stepdd;
        ...
        counter-increment: stepdd {{ $submittedform }};
}
 ...
 <div class="text-center" style="margin-left:330px; margin-top:-6%; background-color:white; width:150vh; height:50vh">
    ...
    <li class="progress-point step-ii" data-query-type="ii"
        ...
        <div class="progress-step-meta">
            <div class="step-title ph12 " style="color: black; font-weight: bold">Payment
            <br>
            Received
      </div>
            ...
            Students  </div>
                                            ...
                                            <li class="progress-point step-offer step-4" data-query-type="cc"
                                                ...
                                                <div class="progress-step-meta ">
                                                    ...
                                                    <div class="step-title ph12" style="color: black; font-weight: bold">Rejected
                                                    <br>
                                                   Students </div>
    ...
    $(".progress-point").on("click", function () {
        ...
        switch (queryType) {
            case 'aa':
                window.location.href = "/viewstudlist";
                break;
            case 'bb':
                window.location.href = "/verifylist";
                break;
            case 'cc':
                window.location.href = "/rejectedlist";
                break;
            case 'dd':
